...
class Changelog {
    ...
    getCommitInfos(from, to) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            commitInfos = commitInfos.filter(c => { var _a; return !((_a = c.githubIssue) === null || _a === void 0 ? void 0 : _a.labels.map(l => l.name).includes(this.config.ignoreLabel)); });
    ...
    getListOfUniquePackages(sha) {
        return __awaiter(this, void 0, void 0, function* () {
            let changedPaths = yield Git.changedPaths(sha);
            return changedPaths
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const commit of commits) {
                ...
                if (login && shouldKeepCommiter && !committers[login]) {
                    committers[login] = this.sanitizeCommitter(yield this.github.getUserData(user));
                }
            }
    ...
    groupByRelease(commits) {
        let releaseMap = {};
        function pushCommit(currentTag, commit) {
            var _a;
            ...
            let prUserLogin = (_a = commit.githubIssue) === null || _a === void 0 ? void 0 : _a.user.login;
